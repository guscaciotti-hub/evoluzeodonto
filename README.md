...
Cópia **fiel** do site médico. Nada foi reescrito ainda. Antes de publicar, todos os pontos do item 10 do dossiê precisam ser trocados (domínio, IDs de rastreamento, Supabase, webhook, branch do deploy).
